...
class Patrimonio extends React.Component {
	...
	<h2 className="subtitle-patrimonio">
        ...
        <ul className="text-patrimonio">
            <li><a href="part-1">O patrimônio como palco</a></li>
            <li><a href="part-2">O que significa ser patrimônio?</a></li>
            <li><a href="part-3">Quem é responsável pela lista?</a></li>
            <li><a href="part-4">Patrimôio Cultural Imaterial da Humanidade</a></li>
        </ul>
